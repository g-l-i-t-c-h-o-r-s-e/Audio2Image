This script converts your audio into an umcompressed format and encodes it into an uncompressed image, so that you can apply image/video filters to the data and databend it.
