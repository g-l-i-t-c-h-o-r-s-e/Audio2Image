...
# Setup:
Grab a copy of AHk Studio (You can use ALT+R to run the script quickly): https://www.maestrith.com/ahk-studio/ | https://github.com/maestrith/AHK-Studio/archive/master.zip <br>
